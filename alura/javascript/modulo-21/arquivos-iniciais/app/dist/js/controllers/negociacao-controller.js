...
export default class NegociacaoController {
    ...
    service = new NegociacoesService();
    constructor() {
    ...
    importaDados() {
        this.service
            ...
            return negociacoesDeHoje.filter((negociacaoAtual) => !this.negociacoes.lista().some(negociacao => negociacao.ehIgual(negociacaoAtual)));
        })
            .then((negociacoesDeHoje) => {
